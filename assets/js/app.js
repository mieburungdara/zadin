...
$.fn.AdminSettings = function (settings) {
	...
	var Theme = (localStorage.getItem('Theme') == 'false') ? false : true;
	// var Layout = (localStorage.getItem('Layout') == "vertical") ? "vertical" : 'horizontal';
	var LogoBg = localStorage.getItem('LogoBg') ? localStorage.getItem('LogoBg') : 'skin1';
	var NavbarBg = localStorage.getItem('NavbarBg') ? localStorage.getItem('NavbarBg') : 'skin1';
	console.log('SidebarType ' + localStorage.getItem('SidebarType'));
	var SidebarType = localStorage.getItem('SidebarType') ? localStorage.getItem('SidebarType') : 'full';
	var SidebarColor = localStorage.getItem('SidebarColor') ? localStorage.getItem('SidebarColor') : 'skin6';
	var SidebarPosition = (localStorage.getItem('SidebarPosition') == 'true') ? true : false;
	var HeaderPosition = (localStorage.getItem('HeaderPosition') == 'true') ? true : false;
	var defaults = {
		Theme: Theme, // this can be true or false ( true means dark and false means light ),
		...
		LogoBg: LogoBg, // You can change the Value to be skin1/skin2/skin3/skin4/skin5/skin6 
		// LogoBg: 'skin1', // You can change the Value to be skin1/skin2/skin3/skin4/skin5/skin6 

		NavbarBg: NavbarBg, // You can change the Value to be skin1/skin2/skin3/skin4/skin5/skin6 
		// NavbarBg: 'skin1', // You can change the Value to be skin1/skin2/skin3/skin4/skin5/skin6

		SidebarType: SidebarType, // You can change it full / mini-sidebar

		SidebarColor: SidebarColor, // You can change the Value to be skin1/skin2/skin3/skin4/skin5/skin6
		// SidebarColor: 'skin6', // You can change the Value to be skin1/skin2/skin3/skin4/skin5/skin6

		SidebarPosition: SidebarPosition, // it can be true / false
		// SidebarPosition: true, // it can be true / false ( true means Fixed and false means absolute )

		HeaderPosition: HeaderPosition, // it can be true / false
		...
		ManageThemeBackground: function () {
			...
			function setlogobg() {
				...
				if (lbg != undefined && lbg != "") {
					...
					if ($('#' + myid + ' .topbar .top-navbar .navbar-header').attr("data-logobg") == "skin6") {
				...
				case 'full':
					...
					$('.sidebartoggler').on("click", function () {
						...
						if ($("#main-wrapper").hasClass("mini-sidebar")) {
							...
							$("#main-wrapper").attr("data-sidebartype", "mini-sidebar");
							localStorage.SidebarType = 'mini-sidebar';
						} else {
							$(".sidebartoggler").prop("checked", !1);
							$("#main-wrapper").attr("data-sidebartype", "full");
							localStorage.SidebarType = 'full';
						}
					});
					break;
					//****************************
