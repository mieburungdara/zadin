...
if ($jenis_tabel == 'reguler_table') {
    ...
    $string .= "\n\n    public function index()
    {
        ...
        \$this->render_view('$c_url/$v_list', \$data);
    }";
...
$string .= "\n\t    );
            \$this->render_view('$c_url/$v_read', \$data);
        } else {
...
$string .= "\n\t);
        \$this->render_view('$c_url/$v_form', \$data);
    }
...
if ($export_word == '1') {
    $string .= "\n\n    public function word()
    {
        ...
        \$this->render_view('" . $c_url . "/" . $v_doc . "',\$data);
    }";
}
...
if ($export_pdf == '1') {
    $string .= "\n\n    function pdf()
    {
        ...
        \$html = \$this->render_view('" . $c_url . "/" . $v_pdf . "', \$data, true);
