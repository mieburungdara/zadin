...
if (isset($_POST['generate'])) {
    ...
    $export_excel = isset($_POST['export_excel']) ? safe($_POST['export_excel']) : 0;
    $export_word  = isset($_POST['export_word']) ? safe($_POST['export_word']) : 0;
    $export_pdf   = isset($_POST['export_pdf']) ? safe($_POST['export_pdf']) : 0;
