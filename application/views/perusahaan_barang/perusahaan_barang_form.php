<div class="row page-titles">
	...
	<h3 class="text-themecolor mb-0">Tambah Perusahaan_barang</h3>
	</div>
	</div>
	...
	<div class="card-body"><div class="row mt-3"><div class="col-sm-12 col-md-6">
	    ...
	    <div class="form-group">
            <label for="varchar">Sk <?php echo form_error('sk') ?></label>
            <input type="text" class="form-control" name="sk" id="sk" placeholder="Sk" value="<?php echo $sk; ?>" />
        </div></div><div class="col-sm-12 col-md-6">
	    <div class="form-group">
