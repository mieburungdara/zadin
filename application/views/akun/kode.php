<div class="row mt-3">
    <div class="col-12">
        <div class="card">
            <form>
                <div class="card-body">
                    <h4 class="card-title">Group Akun</h4>
...
?>
                            <button type="button" class="btn btn-info waves-effect waves-light btn-sm mb-2 mr-2" data-toggle="modal" data-target="#bs-example-modal-lg">Tambah Kode Akun</button>
...
foreach ($this->db->get('akun_kode')->result() as $akl) {
    ...
    $get_kelompok = $this->db->get('akun_kelompok')->row();
                            ...
                            <div class="col-5">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="input_kelompok" id="input_kelompok" required>
                                        ...
                                        <?php
foreach ($this->db->get('akun_kelompok')->result() as $ka) {
...
$(document).ready(function() {
    ...
    $('.editbtn').on('click', function() {
        ...
        console.log(data);
        var regex = /\[([0-9]+)\]/;
        var matches = data[3].match(regex);
        // console.log(matches[1]);

        $('#update_id').val(data[0]);
        $('#edit_kode').val(data[1]);
        $('#edit_nama').val(data[2]);
        $('#edit_kelompok').val(matches[1]);
        $('#edit_keterangan').val(data[4]);
    });
});
</script>
<script>
