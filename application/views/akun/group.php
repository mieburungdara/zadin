                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-header">group Akun</th>
...
function addToDatabase() {
    ...
    $.ajax({
        url: "<?=base_url('akun/group_tambah'); ?>",
        type: "POST",
...
function deleteRecord(id) {
    if (confirm("Apa kamu yakin ingin menhhgapus baris group akun ini?")) {
        $.ajax({
            url: "<?=base_url('akun/group_hapus'); ?>",
            type: "POST",
            data: 'id=' + id,
            success: function(data) {
                console.log(data.trim());
                $("#table-row-" + data.trim()).remove();
            }
        });
    }
}
