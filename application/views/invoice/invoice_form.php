<div class="row page-titles">
	...
	<h3 class="text-themecolor mb-0">Tambah Invoice</h3>
	</div>
	</div>
	...
	<div class="card-body"><div class="row mt-3"><div class="col-sm-12 col-md-6">
	    <div class="form-group">
            <label for="int">Other Key <?php echo form_error('other_key') ?></label>
            <input type="text" class="form-control" name="other_key" id="other_key" placeholder="Other Key" value="<?php echo $other_key; ?>" />
