...
<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        <h3 class="text-themecolor mb-0">Info Jenis_terminal</h3>
    </div>
</div>
...
<div class="card-body">
    ...
    <div class="col-md-4">
        <?php echo anchor(site_url("jenis_terminal/create"), "Tambah Data", "class='btn btn-info'"); ?>
</div>
    ...
    <div class="table-responsive">
		...
		<th>Operasi</th>
            ...
            foreach ($jenis_terminal_data as $jenis_terminal)
            {
                ?>
                <tr>
			<td><?php echo $this->Reza_model->show_ref($this->db->database, "jenis_terminal", "nama") ? $this->Reza_model->get_ref_val($this->db->database, 'jenis_terminal', 'nama', $jenis_terminal->nama)->nama : $jenis_terminal->nama; ?></td>
			...
			<td><?php echo $this->Reza_model->show_ref($this->db->database, "jenis_terminal", "css") ? $this->Reza_model->get_ref_val($this->db->database, 'jenis_terminal', 'css', $jenis_terminal->css)->nama : $jenis_terminal->css; ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('jenis_terminal/read/'.$jenis_terminal->id),'Lihat','class="btn btn-xs waves-effect waves-light btn-outline-dark"'); 
				echo ' | '; 
