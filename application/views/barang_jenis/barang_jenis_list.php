...
<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        <h3 class="text-themecolor mb-0">Info Barang_jenis</h3>
    </div>
</div>
    ...
    <div class="table-responsive">
		...
		<th>Operasi</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('barang_jenis/read/'.$barang_jenis->id),'Lihat','class="btn btn-xs waves-effect waves-light btn-outline-dark"'); 
				echo ' | '; 
