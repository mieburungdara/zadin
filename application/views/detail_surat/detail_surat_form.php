<div class="row page-titles">
	...
	<h3 class="text-themecolor mb-0">Tambah Detail_surat</h3>
	</div>
	</div>
	...
	<div class="card-body"><div class="row mt-3"><div class="col-sm-12 col-md-6">
	    ...
	    <div class="form-group">
            <label for="tinyint">Bulan <?php echo form_error('bulan') ?></label>
