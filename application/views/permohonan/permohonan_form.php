<div class="row page-titles">
	...
	<h3 class="text-themecolor mb-0">Tambah Permohonan</h3>
	</div>
	</div>
	...
	<div class="card-body"><div class="row mt-3"><div class="col-sm-12 col-md-6">
	    ...
	    <div class="form-group">
            <label for="int">Kapal <?php echo form_error('kapal') ?></label>
            <input type="text" class="form-control" name="kapal" id="kapal" placeholder="Kapal" value="<?php echo $kapal; ?>" />
        </div></div><div class="col-sm-12 col-md-6">
	    <div class="form-group">
