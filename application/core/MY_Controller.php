...
class Admin_Controller extends MY_Controller
{
    ...
    {
        $this->load->view('skin1/templates/header', $data);
        $this->load->view('skin1/templates/header_menu', $data);
        $this->load->view('skin1/templates/side_menubar', $data);
        $this->load->view($page, $data);
        $this->load->view('skin1/templates/footer', $data);
    }
